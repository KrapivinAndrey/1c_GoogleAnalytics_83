...
Функция ПрочитатьДополнительныеПараметры()
	...
	Для Сч = 1 По макет.ВысотаСтраницы Цикл
...
Функция ИнициализироватьПараметрыКлиентСервер(ОсновнаяФорма = Неопределено) Экспорт
	...
	ПараметрыКлиентСерверGA.Вставить("ДопПараметры");
	...
	ПараметрыКлиентСерверGA.ДопПараметры				= ПрочитатьДополнительныеПараметры();
